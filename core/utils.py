"""Utility functions for MCP Flux server."""
...
def format_image_result(data: dict[str, Any]) -> str:
    ...
    """
    return json.dumps(
        _with_submission_guidance(data, "flux_get_task", "flux_get_tasks_batch"),
        ensure_ascii=False,
        indent=2,
    )
...
def format_task_result(data: dict[str, Any]) -> str:
    ...
    """
    return json.dumps(
        _with_task_guidance(data, "flux_get_task", "flux_get_tasks_batch"),
        ensure_ascii=False,
        indent=2,
    )
